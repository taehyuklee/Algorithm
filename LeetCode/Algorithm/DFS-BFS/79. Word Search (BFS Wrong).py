...
class Solution:
    def exist(self, board: List[List[str]], word: str) -> bool:
        ...
        def bfs(x0, y0, board, word):
            ...
            Q.append([x0, y0, word[0], 1, cur_word_path])
            ...
            while Q:
                ...
                x_old, y_old, cur_word, next_idx, cur_word_path = Q.popleft()
                ...
                for d in range(4):
                    ...
                    if next_idx >= len(word):
                        continue
                    if visit[x_new][y_new] == False and board[x_new][y_new] == word[next_idx]:
                        cur_path =  cur_word_path + word[next_idx]
                        Q.append([x_new, y_new, word[next_idx], next_idx+1, cur_path])
